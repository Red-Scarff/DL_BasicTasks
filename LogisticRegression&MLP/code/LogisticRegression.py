...
input_dim = 28*28
output_dim = 10
model_sgd = LogisticRegression(input_dim, output_dim).to(device)  # 为SGD训练初始化模型
model_adam = LogisticRegression(input_dim, output_dim).to(device)  # 为Adam训练初始化模型
...
# 使用Adam优化器训练
print("Training Logistic Regression with Adam...")
...
plot_results(train_losses_sgd, train_accs_sgd, test_losses_sgd, test_accs_sgd, 'Logistic Regression (SGD)')
plot_results(train_losses_adam, train_accs_adam, test_losses_adam, test_accs_adam, 'Logistic Regression (Adam)')
